...
//#define LRLEVEL 4
//#define LRX0 80.125f    //minimum x coord of LR
...
inline __device__ void AddForce(float* f)
{
    f[1] -= 0.0555555556f*3.f*DPDT;
    f[3] += 0.0555555556f*3.f*DPDT;
    f[5] -= 0.0277777778f*3.f*DPDT;
    f[6] += 0.0277777778f*3.f*DPDT;
    f[7] += 0.0277777778f*3.f*DPDT;
    f[8] -= 0.0277777778f*3.f*DPDT;
    f[10]-= 0.0277777778f*3.f*DPDT;
    f[12]+= 0.0277777778f*3.f*DPDT;
    f[15]-= 0.0277777778f*3.f*DPDT;
    f[17]+= 0.0277777778f*3.f*DPDT;
}
...
inline __device__ void mrt_collide(float* f, float omega, float a)
{
    float m[19];
    //float u,v,w;    
    m[3] = f[ 1]-f[ 3]+f[ 5]-f[ 6]-f[ 7]+f[ 8]+f[10]-f[12]+f[15]-f[17];
