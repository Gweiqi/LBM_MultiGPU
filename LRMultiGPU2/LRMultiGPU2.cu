...
#define ZDIM 4
#define TMAX 60
#define STARTF 200000

#define OBSTR1 20.f
#define OBSTX1 100.5f
#define OBSTY1 160.5f
#define OBSTZ1 15.5f
...
#define LRLEVEL 2
#define LRX0 20.75f	//minimum x coord of LR
#define XLRDIM 320	//number of nodes in x
#define LRY0 100.75f
#define YLRDIM 400
#define LRZ0 -0.25f
#define ZLRDIM 8
...
int main(int argc, char *argv[])
{
	...
	cudaMalloc((void **) &   uAv_d[n], pitch*YDIM*ZDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) &   vAv_d[n], pitch*YDIM*ZDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) &   wAv_d[n], pitch*YDIM*ZDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) & uFluc_d[n], pitch*YDIM*ZDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) & vFluc_d[n], pitch*YDIM*ZDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) & wFluc_d[n], pitch*YDIM*ZDIM/GPU_N*sizeof(float));
    ...
    cudaMalloc((void **) &   uAvLR_d[n], LRpitch*YLRDIM*ZLRDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) &   vAvLR_d[n], LRpitch*YLRDIM*ZLRDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) &   wAvLR_d[n], LRpitch*YLRDIM*ZLRDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) & uFlucLR_d[n], LRpitch*YLRDIM*ZLRDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) & vFlucLR_d[n], LRpitch*YLRDIM*ZLRDIM/GPU_N*sizeof(float));
	cudaMalloc((void **) & wFlucLR_d[n], LRpitch*YLRDIM*ZLRDIM/GPU_N*sizeof(float));
