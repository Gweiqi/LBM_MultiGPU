...
#define DYNY1 123
#define DYNY2 1
#define KP 0.0f //p-control constant
...
if(MODEL == "MRT"){
feq1 = 0.1031746045f*rho+ 0.032375918f*usqr+  0.1666666667f*u                                                   ;
feq2 = 0.1031746045f*rho+ 0.032375918f*usqr+  0.1666666667f*v                       ;
feq3 = 0.1031746045f*rho+ 0.032375918f*usqr+ -0.1666666667f*u                                                   ;
feq4 = 0.1031746045f*rho+ 0.032375918f*usqr+ -0.1666666667f*v                       ;
feq5 = 0.0158730149f*rho+ 0.033572690f*usqr+  0.083333333f*( u+v)                            ;
feq6 = 0.0158730149f*rho+ 0.033572690f*usqr+ -0.083333333f*( u-v)                            ;
feq7 = 0.0158730149f*rho+ 0.033572690f*usqr+ -0.083333333f*( u+v)                            ;
feq8 = 0.0158730149f*rho+ 0.033572690f*usqr+  0.083333333f*( u-v)                            ;
feq9 = 0.1031746045f*rho+ 0.032375918f*usqr+  0.1666666667f*w;
feq10= 0.0158730149f*rho+ 0.033572690f*usqr+  0.083333333f*( u+w)                                 ;
feq11= 0.0158730149f*rho+ 0.033572690f*usqr+  0.083333333f*( v+w);
feq12= 0.0158730149f*rho+ 0.033572690f*usqr+ -0.083333333f*( u-w)                            ;
feq13= 0.0158730149f*rho+ 0.033572690f*usqr+ -0.083333333f*( v-w);
feq14= 0.1031746045f*rho+ 0.032375918f*usqr+ -0.1666666667f*w;
feq15= 0.0158730149f*rho+ 0.033572690f*usqr+  0.083333333f*(u-w)                            ;
feq16= 0.0158730149f*rho+ 0.033572690f*usqr+  0.083333333f*(v-w);
feq17= 0.0158730149f*rho+ 0.033572690f*usqr+ -0.083333333f*(u+w)                            ;
feq18= 0.0158730149f*rho+ 0.033572690f*usqr+ -0.083333333f*(v+w);
...
usqr = u*u+v*v+w*w;
feq0 =(0.3333333333f*(rho-1.5f*usqr));
feq1 =(0.0555555556f*(rho+3.0f*u+4.5f*u*u-1.5f*usqr));                
feq2 =(0.0555555556f*(rho+3.0f*v+4.5f*v*v-1.5f*usqr));
feq3 =(0.0555555556f*(rho-3.0f*u+4.5f*u*u-1.5f*usqr));
feq4 =(0.0555555556f*(rho-3.0f*v+4.5f*v*v-1.5f*usqr));
feq5 =(0.0277777778f*(rho+3.0f*(u+v)+4.5f*(u+v)*(u+v)-1.5f*usqr));
feq6 =(0.0277777778f*(rho+3.0f*(-u+v)+4.5f*(-u+v)*(-u+v)-1.5f*usqr));
feq7 =(0.0277777778f*(rho+3.0f*(-u-v)+4.5f*(-u-v)*(-u-v)-1.5f*usqr));
feq8 =(0.0277777778f*(rho+3.0f*(u-v)+4.5f*(u-v)*(u-v)-1.5f*usqr));
feq9 =(0.0555555556f*(rho+3.0f*w+4.5f*w*w-1.5f*usqr));
feq10=(0.0277777778f*(rho+3.0f*(u+w)+4.5f*(u+w)*(u+w)-1.5f*usqr));
feq11=(0.0277777778f*(rho+3.0f*(v+w)+4.5f*(v+w)*(v+w)-1.5f*usqr));
feq12=(0.0277777778f*(rho+3.0f*(-u+w)+4.5f*(-u+w)*(-u+w)-1.5f*usqr));
feq13=(0.0277777778f*(rho+3.0f*(-v+w)+4.5f*(-v+w)*(-v+w)-1.5f*usqr));
feq14=(0.0555555556f*(rho-3.0f*w+4.5f*w*w-1.5f*usqr));
feq15=(0.0277777778f*(rho+3.0f*(u-w)+4.5f*(u-w)*(u-w)-1.5f*usqr));
feq16=(0.0277777778f*(rho+3.0f*(v-w)+4.5f*(v-w)*(v-w)-1.5f*usqr));
feq17=(0.0277777778f*(rho+3.0f*(-u-w)+4.5f*(-u-w)*(-u-w)-1.5f*usqr));
feq18=(0.0277777778f*(rho+3.0f*(-v-w)+4.5f*(-v-w)*(-v-w)-1.5f*usqr));
...
float meq[19]={0};
//float ftemp[19]={0};
//bgk_meq(meq,m[0],m[3],m[5],m[7]);
//
//for(int i = 0; i<19; i++)
//    meq[i] = m[i]-omega*(m[i]-meq[i]);

bgk_meq(meq,m[0],m[3],m[5],m[7]);

meq[9] =  m[9] -omega*(m[9]-meq[9]);
meq[11] = m[11]-omega*(m[11]-meq[11]);
meq[13] = m[13]-omega*(m[13]-meq[13]);
meq[14] = m[14]-omega*(m[14]-meq[14]);
meq[15] = m[15]-omega*(m[15]-meq[15]);
//meq[1 ] = m[1 ]-1.19f*(m[1 ]-meq[1 ]);
//meq[2 ] = m[2 ]-1.4f *(m[2 ]-meq[2 ]);
//meq[10] = m[10]-1.4f *(m[10]-meq[10]);
//meq[12] = m[12]-1.4f *(m[12]-meq[12]);
//meq[4 ] = m[4 ]-1.2f *(m[4 ]-meq[4 ]);
//meq[6 ] = m[6 ]-1.2f *(m[6 ]-meq[6 ]);
//meq[8 ] = m[8 ]-1.2f *(m[8 ]-meq[8 ]);
//meq[16] = m[16]-1.98f*(m[16]-meq[16]);
//meq[17] = m[17]-1.98f*(m[17]-meq[17]);
//meq[18] = m[18]-1.98f*(m[18]-meq[18]);
...
//    f[i] -= ftemp[i];
	...
	f[0 ]-=omega*(f[0 ]-0.3333333333f*(rho-1.5f*usqr));
	f[1 ]-=omega*(f[1 ]-0.0555555556f*(rho+3.0f*u+4.5f*u*u-1.5f*usqr));                
	f[2 ]-=omega*(f[2 ]-0.0555555556f*(rho+3.0f*v+4.5f*v*v-1.5f*usqr));
	f[3 ]-=omega*(f[3 ]-0.0555555556f*(rho-3.0f*u+4.5f*u*u-1.5f*usqr));
	f[4 ]-=omega*(f[4 ]-0.0555555556f*(rho-3.0f*v+4.5f*v*v-1.5f*usqr));
	f[5 ]-=omega*(f[5 ]-0.0277777778f*(rho+3.0f*(u+v)+4.5f*(u+v)*(u+v)-1.5f*usqr));
	f[6 ]-=omega*(f[6 ]-0.0277777778f*(rho+3.0f*(-u+v)+4.5f*(-u+v)*(-u+v)-1.5f*usqr));
	f[7 ]-=omega*(f[7 ]-0.0277777778f*(rho+3.0f*(-u-v)+4.5f*(-u-v)*(-u-v)-1.5f*usqr));
	f[8 ]-=omega*(f[8 ]-0.0277777778f*(rho+3.0f*(u-v)+4.5f*(u-v)*(u-v)-1.5f*usqr));
	f[9 ]-=omega*(f[9 ]-0.0555555556f*(rho+3.0f*w+4.5f*w*w-1.5f*usqr));
	f[10]-=omega*(f[10]-0.0277777778f*(rho+3.0f*(u+w)+4.5f*(u+w)*(u+w)-1.5f*usqr));
	f[11]-=omega*(f[11]-0.0277777778f*(rho+3.0f*(v+w)+4.5f*(v+w)*(v+w)-1.5f*usqr));
	f[12]-=omega*(f[12]-0.0277777778f*(rho+3.0f*(-u+w)+4.5f*(-u+w)*(-u+w)-1.5f*usqr));
	f[13]-=omega*(f[13]-0.0277777778f*(rho+3.0f*(-v+w)+4.5f*(-v+w)*(-v+w)-1.5f*usqr));
	f[14]-=omega*(f[14]-0.0555555556f*(rho-3.0f*w+4.5f*w*w-1.5f*usqr));
	f[15]-=omega*(f[15]-0.0277777778f*(rho+3.0f*(u-w)+4.5f*(u-w)*(u-w)-1.5f*usqr));
	f[16]-=omega*(f[16]-0.0277777778f*(rho+3.0f*(v-w)+4.5f*(v-w)*(v-w)-1.5f*usqr));
	f[17]-=omega*(f[17]-0.0277777778f*(rho+3.0f*(-u-w)+4.5f*(-u-w)*(-u-w)-1.5f*usqr));
	f[18]-=omega*(f[18]-0.0277777778f*(rho+3.0f*(-v-w)+4.5f*(-v-w)*(-v-w)-1.5f*usqr));
