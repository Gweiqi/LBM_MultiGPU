...
#define VELAV "YES"
#define START_VELAV 10000
#define START_VELFLUC 100000
#define CS 0.0324f
...
SF = (omega*(1.0f-omega2))/((1.0f-omega)*omega2/LRFACTOR);
SF = omega2*0.5f/omega;
...
float Cs = 0.01f;
//omega = 1.0f/(3.0f*(nu0+Cs*Smag*sqrt(2.f))+0.5f);
//omega2 = 1.0f/(1.0f/omega2+3.f*CS*Smag*LRFACTOR*LRFACTOR);
