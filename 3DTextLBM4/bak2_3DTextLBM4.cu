...
#define ZDIM 32
#define TMAX 1000
#define RE 100.f//100.f;
#define UMAX 0.08f
#define METHOD "SHARED" //SINGLE,HYB,TEXT,SHARED
...
{
//	if (x<0 || x>pitch || y<0 || y>YDIM || z<0 || z>ZDIM) return 0;
//	else
...
//	fB[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(2 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(2 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(3 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(3 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(4 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(4 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(5 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(5 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(6 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(6 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(7 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(7 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(8 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(8 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(9 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(9 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(10,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(10,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(11,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(11,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(12,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(12,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(13,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(13,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(14,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(14,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(15,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(15,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(16,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(16,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(17,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(17,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(18,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(18,x,y,z,pitch,YDIM,ZDIM)];
	
//	float f0;//,f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16,f17,f18;
//	float f0  = fA[j+pitch*YDIM*ZDIM];
//	float f0  = fA[f_mem(0 ,x,y,z,pitch,YDIM,ZDIM)];
//	f0  = tex2D(texRef_f0A ,x,y+YDIM*z);
//	f1  = tex2D(texRef_f1A ,x,y+YDIM*z);
//	f2  = tex2D(texRef_f2A ,x,y+YDIM*z);
//	f3  = tex2D(texRef_f3A ,x,y+YDIM*z);
//	f4  = tex2D(texRef_f4A ,x,y+YDIM*z);
//	f5  = tex2D(texRef_f5A ,x,y+YDIM*z);
//	f6  = tex2D(texRef_f6A ,x,y+YDIM*z);
//	f7  = tex2D(texRef_f7A ,x,y+YDIM*z);
//	f8  = tex2D(texRef_f8A ,x,y+YDIM*z);
//	f9  = tex2D(texRef_f9A ,x,y+YDIM*z);
//	f10 = tex2D(texRef_f10A,x,y+YDIM*z);
//	f11 = tex2D(texRef_f11A,x,y+YDIM*z);
//	f12 = tex2D(texRef_f12A,x,y+YDIM*z);
//	f13 = tex2D(texRef_f13A,x,y+YDIM*z);
//	f14 = tex2D(texRef_f14A,x,y+YDIM*z);
//	f15 = tex2D(texRef_f15A,x,y+YDIM*z);
//	f16 = tex2D(texRef_f16A,x,y+YDIM*z);
//	f17 = tex2D(texRef_f17A,x,y+YDIM*z);
//	f18 = tex2D(texRef_f18A,x,y+YDIM*z);
//	float f1  = fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//	f1  = fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//	f2  = fA[f_mem(2 ,x,y,z,pitch,YDIM,ZDIM)];
//	f3  = fA[f_mem(3 ,x,y,z,pitch,YDIM,ZDIM)];
//	f4  = fA[f_mem(4 ,x,y,z,pitch,YDIM,ZDIM)];
//	f5  = fA[f_mem(5 ,x,y,z,pitch,YDIM,ZDIM)];
//	f6  = fA[f_mem(6 ,x,y,z,pitch,YDIM,ZDIM)];
//	f7  = fA[f_mem(7 ,x,y,z,pitch,YDIM,ZDIM)];
//	f8  = fA[f_mem(8 ,x,y,z,pitch,YDIM,ZDIM)];
//	f9  = fA[f_mem(9 ,x,y,z,pitch,YDIM,ZDIM)];
//	f10 = fA[f_mem(10,x,y,z,pitch,YDIM,ZDIM)];
//	f11 = fA[f_mem(11,x,y,z,pitch,YDIM,ZDIM)];
//	f12 = fA[f_mem(12,x,y,z,pitch,YDIM,ZDIM)];
//	f13 = fA[f_mem(13,x,y,z,pitch,YDIM,ZDIM)];
//	f14 = fA[f_mem(14,x,y,z,pitch,YDIM,ZDIM)];
//	f15 = fA[f_mem(15,x,y,z,pitch,YDIM,ZDIM)];
//	f16 = fA[f_mem(16,x,y,z,pitch,YDIM,ZDIM)];
//	f17 = fA[f_mem(17,x,y,z,pitch,YDIM,ZDIM)];
//	f18 = fA[f_mem(18,x,y,z,pitch,YDIM,ZDIM)];

//	fB[f_mem(0 ,x,y,z,pitch,YDIM,ZDIM)] = fA[f_mem(0 ,x,y,z,pitch,YDIM,ZDIM)];//+0.01f;
	fB[j] = fA[j];//+0.01f;
//	fB[j+pitch*YDIM*ZDIM+pitch*YDIM*ZDIM] = f2;
//	fB[(x+y*pitch+z*YDIM*pitch)+pitch*YDIM*ZDIM] = f1 ;//+0.01f;
//	fB[f_mem(0 ,x,y,z,pitch,YDIM,ZDIM)] = f0 ;
//	fB[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)] = f1;//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//	fB[f_mem(2 ,x,y,z,pitch,YDIM,ZDIM)] = f2 ;//+0.01f;
//	fB[f_mem(3 ,x,y,z,pitch,YDIM,ZDIM)] = f3 ;//+0.01f;
//	fB[f_mem(4 ,x,y,z,pitch,YDIM,ZDIM)] = f4 ;//+0.01f;
//	fB[f_mem(5 ,x,y,z,pitch,YDIM,ZDIM)] = f5 ;//+0.01f;
//	fB[f_mem(6 ,x,y,z,pitch,YDIM,ZDIM)] = f6 ;//+0.01f;
//	fB[f_mem(7 ,x,y,z,pitch,YDIM,ZDIM)] = f7 ;//+0.01f;
//	fB[f_mem(8 ,x,y,z,pitch,YDIM,ZDIM)] = f8 ;//+0.01f;
//	fB[f_mem(9 ,x,y,z,pitch,YDIM,ZDIM)] = f9 ;//+0.01f;
//	fB[f_mem(10,x,y,z,pitch,YDIM,ZDIM)] = f10;//+0.01f;
//	fB[f_mem(11,x,y,z,pitch,YDIM,ZDIM)] = f11;//+0.01f;
//	fB[f_mem(12,x,y,z,pitch,YDIM,ZDIM)] = f12;//+0.01f;
//	fB[f_mem(13,x,y,z,pitch,YDIM,ZDIM)] = f13;//+0.01f;
//	fB[f_mem(14,x,y,z,pitch,YDIM,ZDIM)] = f14;//+0.01f;
//	fB[f_mem(15,x,y,z,pitch,YDIM,ZDIM)] = f15;//+0.01f;
//	fB[f_mem(16,x,y,z,pitch,YDIM,ZDIM)] = f16;//+0.01f;
//	fB[f_mem(17,x,y,z,pitch,YDIM,ZDIM)] = f17;//+0.01f;
//	fB[f_mem(18,x,y,z,pitch,YDIM,ZDIM)] = f18;//+0.01f;
...
//		f1 = fin[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];
//		f3 = fin[f_mem(1 ,dmax(x-1)      ,y               ,z               ,pitch,YDIM,ZDIM)];
//		f5 = fin[f_mem(7 ,dmin(x+1,XDIM),dmin(y+1,YDIM),z               ,pitch,YDIM,ZDIM)];
//		f7 = fin[f_mem(5 ,dmax(x-1)      ,dmax(y-1)       ,z               ,pitch,YDIM,ZDIM)];
//		f6 = fin[f_mem(8 ,dmax(x-1)      ,dmin(y+1,YDIM),z               ,pitch,YDIM,ZDIM)];
//		f8 = fin[f_mem(6 ,dmin(x+1,XDIM),dmax(y-1)       ,z               ,pitch,YDIM,ZDIM)];
//		f10= fin[f_mem(17,dmin(x+1,XDIM),y               ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];
//		f12= fin[f_mem(15,dmax(x-1)      ,y               ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];
//		f15= fin[f_mem(12,dmin(x+1,XDIM),y               ,dmax(z-1)       ,pitch,YDIM,ZDIM)];
//		f17= fin[f_mem(10,dmax(x-1)      ,y               ,dmax(z-1)       ,pitch,YDIM,ZDIM)];
		f2 = fin[f_mem(4 ,x              ,dmin(y+1,YDIM),z               ,pitch)];
		f4 = fin[f_mem(2 ,x              ,dmax(y-1)       ,z             ,pitch)];
		f9 = fin[f_mem(14,x              ,y               ,dmin(z+1,ZDIM),pitch)];
		f11= fin[f_mem(18,x              ,dmin(y+1,YDIM),dmin(z+1,ZDIM)  ,pitch)];
		f13= fin[f_mem(16,x              ,dmax(y-1)       ,dmin(z+1,ZDIM),pitch)];
		f14= fin[f_mem(9 ,x              ,y               ,dmax(z-1)     ,pitch)];
		f16= fin[f_mem(13,x              ,dmin(y+1,YDIM),dmax(z-1)       ,pitch)];
		f18= fin[f_mem(11,x              ,dmax(y-1)       ,dmax(z-1)     ,pitch)];
		f3 = tex2D(texRef_f1A ,x-1,(y  )+YDIM*(z));
		f1 = tex2D(texRef_f3A ,x+1,(y  )+YDIM*(z));
		f5 = tex2D(texRef_f7A ,x+1,(y+1)+YDIM*(z));
		f6 = tex2D(texRef_f8A ,x-1,(y+1)+YDIM*(z));
		f7 = tex2D(texRef_f5A ,x-1,(y-1)+YDIM*(z));
		f8 = tex2D(texRef_f6A ,x+1,(y-1)+YDIM*(z));
		f10= tex2D(texRef_f17A,x+1,(y  )+YDIM*(z+1));
		f12= tex2D(texRef_f15A,x-1,(y  )+YDIM*(z+1));
		f17= tex2D(texRef_f10A,x-1,(y  )+YDIM*(z-1));
		f15= tex2D(texRef_f12A,x+1,(y  )+YDIM*(z-1));
		fout[j+pitch*YDIM*ZDIM*1 ] = f1 ;
		fout[j+pitch*YDIM*ZDIM*2 ] = f2 ;
		fout[j+pitch*YDIM*ZDIM*3 ] = f3 ;
		fout[j+pitch*YDIM*ZDIM*4 ] = f4 ;
		fout[j+pitch*YDIM*ZDIM*5 ] = f5 ;
		fout[j+pitch*YDIM*ZDIM*6 ] = f6 ;
		fout[j+pitch*YDIM*ZDIM*7 ] = f7 ;
		fout[j+pitch*YDIM*ZDIM*8 ] = f8 ;
		fout[j+pitch*YDIM*ZDIM*9 ] = f9 ;
		fout[j+pitch*YDIM*ZDIM*10] = f10;
		fout[j+pitch*YDIM*ZDIM*11] = f11;
		fout[j+pitch*YDIM*ZDIM*12] = f12;
		fout[j+pitch*YDIM*ZDIM*13] = f13;
		fout[j+pitch*YDIM*ZDIM*14] = f14;
		fout[j+pitch*YDIM*ZDIM*15] = f15;
		fout[j+pitch*YDIM*ZDIM*16] = f16;
		fout[j+pitch*YDIM*ZDIM*17] = f17;
		fout[j+pitch*YDIM*ZDIM*18] = f18;
	}
	else{
		float f0,f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16,f17,f18;
//		f1 = fin[f_mem(1 ,x-1,y  ,z  ,pitch,YDIM,ZDIM)];
//		f3 = fin[f_mem(3 ,x+1,y  ,z  ,pitch,YDIM,ZDIM)];
//		f5 = fin[f_mem(5 ,x-1,y-1,z  ,pitch,YDIM,ZDIM)];
//		f6 = fin[f_mem(6 ,x+1,y-1,z  ,pitch,YDIM,ZDIM)];
//		f7 = fin[f_mem(7 ,x+1,y+1,z  ,pitch,YDIM,ZDIM)];
//		f8 = fin[f_mem(8 ,x-1,y+1,z  ,pitch,YDIM,ZDIM)];
//		f10= fin[f_mem(10,x-1,y  ,z-1,pitch,YDIM,ZDIM)];
//		f12= fin[f_mem(12,x+1,y  ,z-1,pitch,YDIM,ZDIM)];
//		f15= fin[f_mem(15,x-1,y  ,z+1,pitch,YDIM,ZDIM)];
//		f17= fin[f_mem(17,x+1,y  ,z+1,pitch,YDIM,ZDIM)];
...
//	int i = x+y*XDIM+z*XDIM*YDIM;//index on linear mem
	...
	if(im == 1){//BB
		...
		f16= fin[f_mem(13,x              ,dmin(y+1,YDIM),dmax(z-1)       ,pitch)];
		f18= fin[f_mem(11,x              ,dmax(y-1)       ,dmax(z-1)     ,pitch)];
		f3 = tex2D(texRef_f1B ,x-1,(y  )+YDIM*(z));
		f1 = tex2D(texRef_f3B ,x+1,(y  )+YDIM*(z));
		f5 = tex2D(texRef_f7B ,x+1,(y+1)+YDIM*(z));
		f6 = tex2D(texRef_f8B ,x-1,(y+1)+YDIM*(z));
		f7 = tex2D(texRef_f5B ,x-1,(y-1)+YDIM*(z));
		f8 = tex2D(texRef_f6B ,x+1,(y-1)+YDIM*(z));
		f10= tex2D(texRef_f17B,x+1,(y  )+YDIM*(z+1));
		f12= tex2D(texRef_f15B,x-1,(y  )+YDIM*(z+1));
		f17= tex2D(texRef_f10B,x-1,(y  )+YDIM*(z-1));
		f15= tex2D(texRef_f12B,x+1,(y  )+YDIM*(z-1));
		fout[j+pitch*YDIM*ZDIM*1 ] = f1 ;
		fout[j+pitch*YDIM*ZDIM*2 ] = f2 ;
		fout[j+pitch*YDIM*ZDIM*3 ] = f3 ;
		fout[j+pitch*YDIM*ZDIM*4 ] = f4 ;
							...
							int *image, float omega, size_t pitch)//pitch in elements
{
	...
	if(im == 1){//BB
		float f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16,f17,f18;
		f2 = tex2D(texRef_f4A ,x  ,(y+1)+YDIM*(z  ));
		f4 = tex2D(texRef_f2A ,x  ,(y-1)+YDIM*(z  ));
		f9 = tex2D(texRef_f14A,x  ,(y  )+YDIM*(z+1));
		f14= tex2D(texRef_f9A ,x  ,(y  )+YDIM*(z-1));
		f11= tex2D(texRef_f18A,x  ,(y+1)+YDIM*(z+1));
		f18= tex2D(texRef_f11A,x  ,(y-1)+YDIM*(z-1));
		f16= tex2D(texRef_f13A,x  ,(y+1)+YDIM*(z-1));
		f13= tex2D(texRef_f16A,x  ,(y-1)+YDIM*(z+1));

//		f2 = fin[f_mem(4 ,x              ,dmin(y+1,YDIM),z               ,pitch,YDIM,ZDIM)];
//		f4 = fin[f_mem(2 ,x              ,dmax(y-1)       ,z               ,pitch,YDIM,ZDIM)];
//		f9 = fin[f_mem(14,x              ,y               ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];
//		f11= fin[f_mem(18,x              ,dmin(y+1,YDIM),dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];
//		f13= fin[f_mem(16,x              ,dmax(y-1)       ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];
//		f14= fin[f_mem(9 ,x              ,y               ,dmax(z-1)       ,pitch,YDIM,ZDIM)];
//		f16= fin[f_mem(13,x              ,dmin(y+1,YDIM),dmax(z-1)       ,pitch,YDIM,ZDIM)];
//		f18= fin[f_mem(11,x              ,dmax(y-1)       ,dmax(z-1)       ,pitch,YDIM,ZDIM)];
		f3 = tex2D(texRef_f1A ,x-1,(y  )+YDIM*(z));
		f1 = tex2D(texRef_f3A ,x+1,(y  )+YDIM*(z));
		f5 = tex2D(texRef_f7A ,x+1,(y+1)+YDIM*(z));
		f6 = tex2D(texRef_f8A ,x-1,(y+1)+YDIM*(z));
...
//		f2 = fin[f_mem(2 ,x  ,y-1,z  ,pitch,YDIM,ZDIM)];
//		f4 = fin[f_mem(4 ,x  ,y+1,z  ,pitch,YDIM,ZDIM)];
//		f9 = fin[f_mem(9 ,x  ,y  ,z-1,pitch,YDIM,ZDIM)];
//		f11= fin[f_mem(11,x  ,y-1,z-1,pitch,YDIM,ZDIM)];
//		f13= fin[f_mem(13,x  ,y+1,z-1,pitch,YDIM,ZDIM)];
//		f14= fin[f_mem(14,x  ,y  ,z+1,pitch,YDIM,ZDIM)];
//		f16= fin[f_mem(16,x  ,y-1,z+1,pitch,YDIM,ZDIM)];
//		f18= fin[f_mem(18,x  ,y+1,z+1,pitch,YDIM,ZDIM)];
		f1 = tex2D(texRef_f1A ,x-1,y  +YDIM*(z));
		f3 = tex2D(texRef_f3A ,x+1,y  +YDIM*(z));
		f5 = tex2D(texRef_f5A ,x-1,y-1+YDIM*(z));
		f6 = tex2D(texRef_f6A ,x+1,y-1+YDIM*(z));
							...
							int *image, float omega, size_t pitch)//pitch in elements
{
	...
	if(im == 1){//BB
		float f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16,f17,f18;
		f2 = tex2D(texRef_f4B ,x  ,(y+1)+YDIM*(z  ));
		f4 = tex2D(texRef_f2B ,x  ,(y-1)+YDIM*(z  ));
		f9 = tex2D(texRef_f14B,x  ,(y  )+YDIM*(z+1));
		f14= tex2D(texRef_f9B ,x  ,(y  )+YDIM*(z-1));
		f11= tex2D(texRef_f18B,x  ,(y+1)+YDIM*(z+1));
		f18= tex2D(texRef_f11B,x  ,(y-1)+YDIM*(z-1));
		f16= tex2D(texRef_f13B,x  ,(y+1)+YDIM*(z-1));
		f13= tex2D(texRef_f16B,x  ,(y-1)+YDIM*(z+1));
...
//							int XDIM, int YDIM, int ZDIM, size_t pitch)//pitch in elements
{
	int x = threadIdx.x+blockIdx.x*blockDim.x;//coord in linear mem
	int y = threadIdx.y+blockIdx.y*blockDim.y;
	int z = threadIdx.z+blockIdx.z*blockDim.z;
...
//	int i = x+y*blockDim.x*gridDim.x;
	//float u,v,w,rho;//,usqr;
//	int im = image[i];
//	if(x == 0 || y == 0 || z == 0 || x == XDIM-1 || y == YDIM-1 || z == ZDIM-1) im = 1;
	int im = ImageFcn(x,y,z);
...
//	 f1_s[threadIdx.x] = fA[f_mem(1 ,x ,y               ,z               ,pitch,YDIM,ZDIM)];//dmax(x-1)      
//	 f3_s[threadIdx.x] = fA[f_mem(3 ,x ,y               ,z               ,pitch,YDIM,ZDIM)];//dmin(x+1,XDIM)
//	 f5_s[threadIdx.x] = fA[f_mem(5 ,x ,dmax(y-1)       ,z               ,pitch,YDIM,ZDIM)];//dmax(x-1)      
//	 f7_s[threadIdx.x] = fA[f_mem(7 ,x ,dmin(y+1,YDIM),z               ,pitch,YDIM,ZDIM)];//dmin(x+1,XDIM)
//	 f6_s[threadIdx.x] = fA[f_mem(6 ,x ,dmin(y+1,YDIM),z               ,pitch,YDIM,ZDIM)];//dmin(x+1,XDIM)
//	 f8_s[threadIdx.x] = fA[f_mem(8 ,x ,dmax(y-1)       ,z               ,pitch,YDIM,ZDIM)];//dmax(x-1)      
//	f10_s[threadIdx.x] = fA[f_mem(10,x ,y               ,dmax(z-1)       ,pitch,YDIM,ZDIM)];//dmax(x-1)      
//	f12_s[threadIdx.x] = fA[f_mem(12,x ,y               ,dmax(z-1)       ,pitch,YDIM,ZDIM)];//dmin(x+1,XDIM)
//	f15_s[threadIdx.x] = fA[f_mem(15,x ,y               ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];//dmax(x-1)      
//	f17_s[threadIdx.x] = fA[f_mem(17,x ,y               ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];//dmin(x+1,XDIM)
//
	__syncthreads();
	...
	if(im == 1){//BB
		float f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16,f17,f18;
//		if(y != 0){
		f4 = fA[f_mem(2 ,x  ,y-1  ,z  ,pitch)];//fA[f_mem(4 ,x,y,z,pitch,YDIM,ZDIM)];
//		}
//		else if(y != YDIM-1){
		f2 = fA[f_mem(4 ,x  ,y+1  ,z  ,pitch)];//fA[f_mem(2 ,x,y,z,pitch,YDIM,ZDIM)];
//		}
//		if(z != ZDIM-1){
		f9 = fA[f_mem(14,x  ,y    ,z+1,pitch)];//fA[f_mem(9 ,x,y,z,pitch,YDIM,ZDIM)];
		f11= fA[f_mem(18,x  ,y+1  ,z+1,pitch)];//fA[f_mem(11,x,y,z,pitch,YDIM,ZDIM)];
		f13= fA[f_mem(16,x  ,y-1  ,z+1,pitch)];//fA[f_mem(13,x,y,z,pitch,YDIM,ZDIM)];
//		}
//		else if(z != 0){
		f14= fA[f_mem(9 ,x  ,y    ,z-1,pitch)];//fA[f_mem(14,x,y,z,pitch,YDIM,ZDIM)];
		f16= fA[f_mem(13,x  ,y+1  ,z-1,pitch)];//fA[f_mem(16,x,y,z,pitch,YDIM,ZDIM)];
		f18= fA[f_mem(11,x  ,y-1  ,z-1,pitch)];//fA[f_mem(18,x,y,z,pitch,YDIM,ZDIM)];
//		}

//		f2 = fA[f_mem(4 ,x              ,dmin(y+1,YDIM),z               ,pitch,YDIM,ZDIM)];//fA[f_mem(2 ,x,y,z,pitch,YDIM,ZDIM)];
//		f4 = fA[f_mem(2 ,x              ,dmax(y-1)       ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(4 ,x,y,z,pitch,YDIM,ZDIM)];
//		f9 = fA[f_mem(14,x              ,y               ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];//fA[f_mem(9 ,x,y,z,pitch,YDIM,ZDIM)];
//		f11= fA[f_mem(18,x              ,dmin(y+1,YDIM),dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];//fA[f_mem(11,x,y,z,pitch,YDIM,ZDIM)];
//		f13= fA[f_mem(16,x              ,dmax(y-1)       ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];//fA[f_mem(13,x,y,z,pitch,YDIM,ZDIM)];
//		f14= fA[f_mem(9 ,x              ,y               ,dmax(z-1)       ,pitch,YDIM,ZDIM)];//fA[f_mem(14,x,y,z,pitch,YDIM,ZDIM)];
//		f16= fA[f_mem(13,x              ,dmin(y+1,YDIM),dmax(z-1)       ,pitch,YDIM,ZDIM)];//fA[f_mem(16,x,y,z,pitch,YDIM,ZDIM)];
//		f18= fA[f_mem(11,x              ,dmax(y-1)       ,dmax(z-1)       ,pitch,YDIM,ZDIM)];//fA[f_mem(18,x,y,z,pitch,YDIM,ZDIM)];

//		f1 = fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f3 = fA[f_mem(1 ,dmax(x-1)      ,y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(3 ,x,y,z,pitch,YDIM,ZDIM)];
//		f5 = fA[f_mem(7 ,dmin(x+1,XDIM),dmin(y+1,YDIM),z               ,pitch,YDIM,ZDIM)];//fA[f_mem(5 ,x,y,z,pitch,YDIM,ZDIM)];
//		f7 = fA[f_mem(5 ,dmax(x-1)      ,dmax(y-1)       ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(7 ,x,y,z,pitch,YDIM,ZDIM)];
//		f6 = fA[f_mem(8 ,dmax(x-1)      ,dmin(y+1,YDIM),z               ,pitch,YDIM,ZDIM)];//fA[f_mem(6 ,x,y,z,pitch,YDIM,ZDIM)];
//		f8 = fA[f_mem(6 ,dmin(x+1,XDIM),dmax(y-1)       ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(8 ,x,y,z,pitch,YDIM,ZDIM)];
//		f10= fA[f_mem(17,dmin(x+1,XDIM),y               ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];//fA[f_mem(10,x,y,z,pitch,YDIM,ZDIM)];
//		f12= fA[f_mem(15,dmax(x-1)      ,y               ,dmin(z+1,ZDIM) ,pitch,YDIM,ZDIM)];//fA[f_mem(12,x,y,z,pitch,YDIM,ZDIM)];
//		f15= fA[f_mem(12,dmin(x+1,XDIM),y               ,dmax(z-1)       ,pitch,YDIM,ZDIM)];//fA[f_mem(15,x,y,z,pitch,YDIM,ZDIM)];
//		f17= fA[f_mem(10,dmax(x-1)      ,y               ,dmax(z-1)       ,pitch,YDIM,ZDIM)];//fA[f_mem(17,x,y,z,pitch,YDIM,ZDIM)];

		if(threadIdx.x != XDIM-1){
		f1 = f3_s[threadIdx.x+1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		f5 = f7_s[threadIdx.x+1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		f8 = f6_s[threadIdx.x+1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		f10=f17_s[threadIdx.x+1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		f15=f12_s[threadIdx.x+1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		}
		if(threadIdx.x != 0){
		f3 = f1_s[threadIdx.x-1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		f7 = f5_s[threadIdx.x-1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		f6 = f8_s[threadIdx.x-1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		f17=f10_s[threadIdx.x-1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		f12=f15_s[threadIdx.x-1];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		}


//		f1 = f3_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f3 = f1_s[dmax(threadIdx.x-1      )];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f5 = f7_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f7 = f5_s[dmax(threadIdx.x-1      )];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f6 = f8_s[dmax(threadIdx.x-1      )];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f8 = f6_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f10=f17_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f17=f10_s[dmax(threadIdx.x-1      )];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f12=f15_s[dmax(threadIdx.x-1      )];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
//		f15=f12_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z               ,pitch,YDIM,ZDIM)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
...
//		fB[j+pitch*YDIM*ZDIM*1 ] = f1 ;
//		fB[j+pitch*YDIM*ZDIM*2 ] = f2 ;
//		fB[j+pitch*YDIM*ZDIM*3 ] = f3 ;
//		fB[j+pitch*YDIM*ZDIM*4 ] = f4 ;
//		fB[j+pitch*YDIM*ZDIM*5 ] = f5 ;
//		fB[j+pitch*YDIM*ZDIM*6 ] = f6 ;
//		fB[j+pitch*YDIM*ZDIM*7 ] = f7 ;
//		fB[j+pitch*YDIM*ZDIM*8 ] = f8 ;
//		fB[j+pitch*YDIM*ZDIM*9 ] = f9 ;
//		fB[j+pitch*YDIM*ZDIM*10] = f10;
//		fB[j+pitch*YDIM*ZDIM*11] = f11;
//		fB[j+pitch*YDIM*ZDIM*12] = f12;
//		fB[j+pitch*YDIM*ZDIM*13] = f13;
//		fB[j+pitch*YDIM*ZDIM*14] = f14;
//		fB[j+pitch*YDIM*ZDIM*15] = f15;
//		fB[j+pitch*YDIM*ZDIM*16] = f16;
//		fB[j+pitch*YDIM*ZDIM*17] = f17;
//		fB[j+pitch*YDIM*ZDIM*18] = f18;
...
//		f0 = fA[j];
//		f2 = fA[f_mem(2 ,x  ,y-1,z  ,pitch,YDIM,ZDIM)];
//		f4 = fA[f_mem(4 ,x  ,y+1,z  ,pitch,YDIM,ZDIM)];
//		f9 = fA[f_mem(9 ,x  ,y  ,z-1,pitch,YDIM,ZDIM)];
//		f11= fA[f_mem(11,x  ,y-1,z-1,pitch,YDIM,ZDIM)];
//		f13= fA[f_mem(13,x  ,y+1,z-1,pitch,YDIM,ZDIM)];
//		f14= fA[f_mem(14,x  ,y  ,z+1,pitch,YDIM,ZDIM)];
//		f16= fA[f_mem(16,x  ,y-1,z+1,pitch,YDIM,ZDIM)];
//		f18= fA[f_mem(18,x  ,y+1,z+1,pitch,YDIM,ZDIM)];
//
//		f1 = f1_s[dmax(threadIdx.x-1      )];//fA[f_mem(1 ,x-1,y  ,z  ,pitch,YDIM,ZDIM)];
//		f3 = f3_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(3 ,x+1,y  ,z  ,pitch,YDIM,ZDIM)];
//		f5 = f5_s[dmax(threadIdx.x-1      )];//fA[f_mem(5 ,x-1,y-1,z  ,pitch,YDIM,ZDIM)];
//		f6 = f6_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(6 ,x+1,y-1,z  ,pitch,YDIM,ZDIM)];
//		f7 = f7_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(7 ,x+1,y+1,z  ,pitch,YDIM,ZDIM)];
//		f8 = f8_s[dmax(threadIdx.x-1      )];//fA[f_mem(8 ,x-1,y+1,z  ,pitch,YDIM,ZDIM)];
//		f10=f10_s[dmax(threadIdx.x-1      )];//fA[f_mem(10,x-1,y  ,z-1,pitch,YDIM,ZDIM)];
//		f12=f12_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(12,x+1,y  ,z-1,pitch,YDIM,ZDIM)];
//		f15=f15_s[dmax(threadIdx.x-1      )];//fA[f_mem(15,x-1,y  ,z+1,pitch,YDIM,ZDIM)];
//		f17=f17_s[dmin(threadIdx.x+1,XDIM)];//fA[f_mem(17,x+1,y  ,z+1,pitch,YDIM,ZDIM)];
...
//	int i = x+y*blockDim.x*gridDim.x;
	...
	if(im == 1){//BB
		float f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16,f17,f18;
		f1 = fA[f_mem(3 ,dmin(x+1,XDIM),y               ,z              ,pitch)];//fA[f_mem(1 ,x,y,z,pitch,YDIM,ZDIM)];
		f2 = fA[f_mem(4 ,x              ,dmin(y+1,YDIM),z               ,pitch)];//fA[f_mem(2 ,x,y,z,pitch,YDIM,ZDIM)];
		f3 = fA[f_mem(1 ,dmax(x-1)      ,y               ,z             ,pitch)];//fA[f_mem(3 ,x,y,z,pitch,YDIM,ZDIM)];
		f4 = fA[f_mem(2 ,x              ,dmax(y-1)       ,z             ,pitch)];//fA[f_mem(4 ,x,y,z,pitch,YDIM,ZDIM)];
		f5 = fA[f_mem(7 ,dmin(x+1,XDIM),dmin(y+1,YDIM),z                ,pitch)];//fA[f_mem(5 ,x,y,z,pitch,YDIM,ZDIM)];
		f7 = fA[f_mem(5 ,dmax(x-1)      ,dmax(y-1)       ,z             ,pitch)];//fA[f_mem(7 ,x,y,z,pitch,YDIM,ZDIM)];
		f6 = fA[f_mem(8 ,dmax(x-1)      ,dmin(y+1,YDIM),z               ,pitch)];//fA[f_mem(6 ,x,y,z,pitch,YDIM,ZDIM)];
		f8 = fA[f_mem(6 ,dmin(x+1,XDIM),dmax(y-1)       ,z              ,pitch)];//fA[f_mem(8 ,x,y,z,pitch,YDIM,ZDIM)];
		f9 = fA[f_mem(14,x              ,y               ,dmin(z+1,ZDIM),pitch)];//fA[f_mem(9 ,x,y,z,pitch,YDIM,ZDIM)];
		f10= fA[f_mem(17,dmin(x+1,XDIM),y               ,dmin(z+1,ZDIM) ,pitch)];//fA[f_mem(10,x,y,z,pitch,YDIM,ZDIM)];
		f11= fA[f_mem(18,x              ,dmin(y+1,YDIM),dmin(z+1,ZDIM)  ,pitch)];//fA[f_mem(11,x,y,z,pitch,YDIM,ZDIM)];
		f12= fA[f_mem(15,dmax(x-1)      ,y               ,dmin(z+1,ZDIM),pitch)];//fA[f_mem(12,x,y,z,pitch,YDIM,ZDIM)];
		f13= fA[f_mem(16,x              ,dmax(y-1)       ,dmin(z+1,ZDIM),pitch)];//fA[f_mem(13,x,y,z,pitch,YDIM,ZDIM)];
		f14= fA[f_mem(9 ,x              ,y               ,dmax(z-1)     ,pitch)];//fA[f_mem(14,x,y,z,pitch,YDIM,ZDIM)];
		f15= fA[f_mem(12,dmin(x+1,XDIM),y               ,dmax(z-1)      ,pitch)];//fA[f_mem(15,x,y,z,pitch,YDIM,ZDIM)];
		f16= fA[f_mem(13,x              ,dmin(y+1,YDIM),dmax(z-1)       ,pitch)];//fA[f_mem(16,x,y,z,pitch,YDIM,ZDIM)];
		f17= fA[f_mem(10,dmax(x-1)      ,y               ,dmax(z-1)     ,pitch)];//fA[f_mem(17,x,y,z,pitch,YDIM,ZDIM)];
		f18= fA[f_mem(11,x              ,dmax(y-1)       ,dmax(z-1)     ,pitch)];//fA[f_mem(18,x,y,z,pitch,YDIM,ZDIM)];
...
//	cudaFuncSetCacheConfig(mrt_d_single,cudaFuncCachePreferL1);
	...
	//for(int t = 0; t<TMAX; t=t+1){
		...
		if(METHOD == "TEXT"){
		mrt_d_textAB<<<grid, threads>>>(fA_d,fB_d,image_d,omega,pitch_elements);
		mrt_d_textBA<<<grid, threads>>>(fB_d,fA_d,image_d,omega,pitch_elements);
		}
