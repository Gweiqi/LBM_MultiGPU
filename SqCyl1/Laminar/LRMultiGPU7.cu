...
#define OBSTR1 10.f
#define OBSTX1 159.5f
#define OBSTY1 150.5f
#define OBSTZ1 32.5f
...
#define LRLEVEL 2
#define LRX0 139.25f    //minimum x coord of LR
#define XLRDIM 80    //number of nodes in x
#define LRY0 130.25f
#define YLRDIM 160
#define LRZ0 -0.75f
#define ZLRDIM 16
...
//#define LRLEVEL 4
//#define LRX0 130.125f    //minimum x coord of LR
//#define XLRDIM 280    //number of nodes in x
//#define LRY0 139.125f
//#define YLRDIM 160
//#define LRZ0 -0.875f
//#define ZLRDIM 320
//#define ORDER 2 //order of accuracy of interpolation

#define RE 250.f //3000.f//2000.f//100.f;
#define UMAX 0.08f
...
#define VELAV 1
#define START_VELAV   4000 //100000
#define START_VELFLUC 7000 //250000

inline int ImageFcnHost(float x, float y, float z)
{
    int value = 0;
                  ...
                  float **velFluc, float omega, int GPU_N, int GPU)
{
    ...
    for(int i = 0; i<XDIM; i++){
        ...
        int image = ImageFcnHost(i,j,z);
        if(image == 10){
        sumX+=2.f*f[ 1]-2.f*f[ 3]+2.f*f[ 5]+2.f*f[ 8]-2.f*f[ 6];
        sumX+=-2.f*f[ 7]+2.f*f[10]-2.f*f[12]+2.f*f[15]-2.f*f[17];
        sumY+=2.f*f[ 2]-2.f*f[ 4]+2.f*f[ 5]-2.f*f[ 8]+2.f*f[ 6];
        sumY+=-2.f*f[ 7]+2.f*f[11]-2.f*f[13]+2.f*f[16]-2.f*f[18];
        sumZ+=2.f*f[ 9]+2.f*f[10]+2.f*f[11]+2.f*f[12]+2.f*f[13];
        sumZ+=-2.f*f[14]-2.f*f[15]-2.f*f[16]-2.f*f[17]-2.f*f[18];
        }

        }

    }}}
        cout<<"force x is: "<<sumX/(UMAX*UMAX*OBSTR1)<<endl;
        cout<<"force y is: "<<sumY/(UMAX*UMAX*OBSTR1)<<endl;
        cout<<"force z is: "<<sumZ/(UMAX*UMAX*OBSTR1)<<endl;
