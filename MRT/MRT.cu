...
#define LRLEVEL 2
#define LRX0 15.75f	//minimum x coord of LR
...
__global__ void testfunc(float* output)
{
    ...
    f0 = threadIdx.x;//+f1-f1+f1-f1+f1-f1+f1-f1+f1-f1+f1-f1+f1-f1+f1-f1+f1-f1+f1-f1+f1-f1+f1-f1;
	output[threadIdx.x+0 ] = f0 ;
	output[threadIdx.x+1 ] = f1 ;
	output[threadIdx.x+2 ] = f2 ;
	output[threadIdx.x+3 ] = f3 ;
	output[threadIdx.x+4 ] = f4 ;
	output[threadIdx.x+5 ] = f5 ;
	output[threadIdx.x+6 ] = f6 ;
	output[threadIdx.x+7 ] = f7 ;
	output[threadIdx.x+8 ] = f8 ;
	output[threadIdx.x+9 ] = f9 ;
	output[threadIdx.x+10] = f10;
	output[threadIdx.x+11] = f11;
	output[threadIdx.x+12] = f12;
	output[threadIdx.x+13] = f13;
	output[threadIdx.x+14] = f14;
	output[threadIdx.x+15] = f15;
	output[threadIdx.x+16] = f16;
	output[threadIdx.x+17] = f17;
	output[threadIdx.x+18] = f18;
