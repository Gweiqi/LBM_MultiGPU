...
inline __device__ int ImageFcn(int x, int y){
	...
	//else if(abs(x-OBSTX)<OBSTR && abs(y-OBSTY)<OBSTR)
		return 10;
	else
		return 0;
//	return 1;
...
//    m8_00 = 0.25f*(m8_00+m8_01+m8_10+m8_11);
    ...
    float cx,cy,dx,dy;
    cx = 0.0625f*(Sxx_00+Sxx_01-Sxx_10-Sxx_11);
    dy = 0.0625f*(Syy_00-Syy_01+Syy_10-Syy_11);
    cy = 0.125f*(Sxy_00+Sxy_10-Sxy_01-Sxy_11)+0.125f*(v_00+v_11-v_01-v_10);
    dx = 0.125f*(Sxy_00+Sxy_01-Sxy_10-Sxy_11)+0.125f*(u_00+u_11-u_01-u_10);
