...
#define OBSTR1 16.f
#define OBSTX1 96.5f
#define OBSTY1 127.5f
#define OBSTZ1 15.5f

#define OBSTR2 16.f
#define OBSTX2 224.5f
#define OBSTY2 127.5f
#define OBSTZ2 31.5f

#define LRFACTOR 0.5f
#define LRLEVEL 2
#define LRX0 80.25f    //minimum x coord of LR
...
#define RE 100.f //3000.f//2000.f//100.f;
#define UMAX 0.06f
...
//        value = 10;
//Lid Driven Cavity
    if(y == 0 || y == YDIM-1 || z == 0 || z == ZDIM-1 || x == XDIM-1)
        value = 1;
...
inline __device__ void West_Extrap(float* f, float u, int t)
{
    ...
    float w = UMAX;//f[ 9]+f[10]+f[11]+f[12]+f[13]-f[14]-f[15]-f[16]-f[17]-f[18];
