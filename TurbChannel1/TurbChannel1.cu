...
#define CASENAME "TurbChannel1_1"
...
#define ZYPERIODIC "YES"
#define VELAV "YES"
#define START_VELAV 30000
#define START_VELFLUC 50000
#define CS 0.01f
#define FORCE 5.56e-7f
...
////Lid Driven Cavity
//	if(x == 0 || x == XDIM-1 || y == YDIM-1 || z == 0 || z == ZDIM-1)
//		value = 1;
//	else if(y == 0)
//		value = 200;
//	else
...
f7 -=1.0f/36.0f*FORCE;
f8 -=1.0f/36.0f*FORCE;
f11+=1.0f/36.0f*FORCE;
f13-=1.0f/36.0f*FORCE;
f16+=1.0f/36.0f*FORCE;
f18-=1.0f/36.0f*FORCE;
}
...
//	else{
	...
	f3 = fin[f_mem(3 ,dmin_p(x+1,XDIM),y               ,z                  ,pitch)];
	f2 = fin[f_mem(2 ,x               ,dmax_p(y-1,YDIM),z                  ,pitch)];
	f5 = fin[f_mem(5 ,dmax_p(x-1,XDIM),dmax_p(y-1,YDIM),z                  ,pitch)];
	f6 = fin[f_mem(6 ,dmin_p(x+1,XDIM),dmax_p(y-1,YDIM),z                  ,pitch)];
	f4 = fin[f_mem(4 ,x               ,dmin_p(y+1,YDIM),z                  ,pitch)];
	f7 = fin[f_mem(7 ,dmin_p(x+1,XDIM),dmin_p(y+1,YDIM),z                  ,pitch)];
	f8 = fin[f_mem(8 ,dmax_p(x-1,XDIM),dmin_p(y+1,YDIM),z                  ,pitch)];
	f9 = fin[f_mem(9 ,x               ,y               ,dmax_p(z-1,ZDIM)   ,pitch)];
	f10= fin[f_mem(10,dmax_p(x-1,XDIM),y               ,dmax_p(z-1,ZDIM)   ,pitch)];
	f11= fin[f_mem(11,x               ,dmax_p(y-1,YDIM),dmax_p(z-1,ZDIM)   ,pitch)];
	f12= fin[f_mem(12,dmin_p(x+1,XDIM),y               ,dmax_p(z-1,ZDIM)   ,pitch)];
	f13= fin[f_mem(13,x               ,dmin_p(y+1,YDIM),dmax_p(z-1,ZDIM)   ,pitch)];
	f14= fin[f_mem(14,x               ,y               ,dmin_p(z+1,ZDIM)   ,pitch)];
	f15= fin[f_mem(15,dmax_p(x-1,XDIM),y               ,dmin_p(z+1,ZDIM)   ,pitch)];
	f16= fin[f_mem(16,x               ,dmax_p(y-1,YDIM),dmin_p(z+1,ZDIM)   ,pitch)];
	f17= fin[f_mem(17,dmin_p(x+1,XDIM),y               ,dmin_p(z+1,ZDIM)   ,pitch)];
	f18= fin[f_mem(18,x               ,dmin_p(y+1,YDIM),dmin_p(z+1,ZDIM)   ,pitch)];
    }
    else{
	f0 = fin[j];
	f1 = fin[f_mem(1 ,x-1,y  ,z  ,pitch)];
...
f18=(0.052631579f*rho         + -0.1f*v+ -0.1f*w+ 0.0033416876f*(m1)+ 0.003968254f*(m2)             + -0.025f*(m6+m8)+0.125f*(-m17+m18)-0.027777778f*(m10)+(-0.055555556f*(m9) +( 0.25f*(m14))));
	...
	u = UMAX;//f1-f3+f5-f6-f7+f8+f10-f12+f15-f17;
	v = 0.f;//f2-f4+f5+f6-f7-f8+f11-f13+f16-f18;
