...
#define LRX0 255.75f	//minimum x coord of LR
#define XLRDIM 4048	//number of nodes in x
#define LRY0 255.75f
#define YLRDIM 1024

#define RE 100.f
#define UMAX 0.01f
#define METHOD "TEST" //LR,SINGLE,HYB,TEXT,SHARED,SINGLEF,TEST
