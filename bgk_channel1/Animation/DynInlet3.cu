...
#define XDIM 224
#define YDIM 500 //1000
#define ZDIM 8
#define TMAX   300 //2000000
#define STARTF 0
#define DYNY1 200
#define DYNY2 1
#define KP 0.f //0.05f //p-control constant
#define PRERUN 500000 //pre-run duration
#define HEIGHT 200
...
#define UMAX 0.06f //0.06f
#define SmagLES 1 //1,0
#define MODEL "MRT" //BGK,MRT,STREAM
#define REFINEMENT 0 //1,0
#define CS 0.02f
#define DPDX 0.f
#define DPDY -1.224e-7 //-2.2358e-8 //-1.0456e-7

#define VELAV 1
#define START_VELAV    1000000
#define START_VELFLUC  1500000
                  ...
                  float **velFluc, float omega, int GPU_N, int GPU)
{
    ...
    if(GPU == 0){
    outputslice<<"VARIABLES = \"X\",\"Y\",\"u\",\"v\",\"w\",\"rho\",\"Smag\"\n";
    outputslice<<"ZONE F=POINT, I="<<XDIM<<", J="<<YDIM<<"\n";
    }
...
void WriteResults_slice(ostream &outputslice, float *gin, float omega)
{
    float f[19];
    outputslice<<"VARIABLES = \"X\",\"Y\",\"u\",\"v\",\"w\",\"rho\",\"Smag\"\n";
    outputslice<<"ZONE F=POINT, I="<<XDIM<<", J="<<YDIM<<"\n";
...
//            dpdy *= 0.99f;
    ...
    for(int n = 0; n<1; n++){
        ...
        WriteResults_slice(outputslice,g_h[n],omega);
    }
    }
