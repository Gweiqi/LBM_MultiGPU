...
#define LRLEVEL 2
#define LRX0 3.75f	//minimum x coord of LR
							...
							float omega, size_t pitch, int GPU, int zInner)//pitch in elements
{
	...
	f9 = fA[f_memLR(9 ,x  ,y  ,z,pitch,zInner)];
	f10= fA[f_memLR(10,x-1,y  ,z,pitch,zInner)];
	f11= fA[f_memLR(11,x  ,y-1,z,pitch,zInner)];
	f12= fA[f_memLR(12,x+1,y  ,z,pitch,zInner)];
	f13= fA[f_memLR(13,x  ,y+1,z,pitch,zInner)];
	f14= fA[f_memLR(14,x  ,y  ,z,pitch,zInner)];
	f15= fA[f_memLR(15,x-1,y  ,z,pitch,zInner)];
	f16= fA[f_memLR(16,x  ,y-1,z,pitch,zInner)];
	f17= fA[f_memLR(17,x+1,y  ,z,pitch,zInner)];
	f18= fA[f_memLR(18,x  ,y+1,z,pitch,zInner)];
	...
	if(im == 1 || im ==10){//BB
        ...
        if(im == 100)//north outlet
        {
           	f0 = fA[f_memLR(0 ,x,y-1,z,pitch,zInner)];
        	f1 = fA[f_memLR(1 ,x,y-1,z,pitch,zInner)];
        	f3 = fA[f_memLR(3 ,x,y-1,z,pitch,zInner)];
        	f2 = fA[f_memLR(2 ,x,y-1,z,pitch,zInner)];
        	f5 = fA[f_memLR(5 ,x,y-1,z,pitch,zInner)];
        	f6 = fA[f_memLR(6 ,x,y-1,z,pitch,zInner)];
        	f4 = fA[f_memLR(4 ,x,y-1,z,pitch,zInner)];
        	f7 = fA[f_memLR(7 ,x,y-1,z,pitch,zInner)];
        	f8 = fA[f_memLR(8 ,x,y-1,z,pitch,zInner)];
        	f9 = fA[f_memLR(9 ,x,y-1,z,pitch,zInner)];
        	f10= fA[f_memLR(10,x,y-1,z,pitch,zInner)];
        	f11= fA[f_memLR(11,x,y-1,z,pitch,zInner)];
        	f12= fA[f_memLR(12,x,y-1,z,pitch,zInner)];
        	f13= fA[f_memLR(13,x,y-1,z,pitch,zInner)];
        	f14= fA[f_memLR(14,x,y-1,z,pitch,zInner)];
        	f15= fA[f_memLR(15,x,y-1,z,pitch,zInner)];
        	f16= fA[f_memLR(16,x,y-1,z,pitch,zInner)];
        	f17= fA[f_memLR(17,x,y-1,z,pitch,zInner)];
        	f18= fA[f_memLR(18,x,y-1,z,pitch,zInner)];
							...
							float omega, size_t pitch, int GPU, int zInner)//pitch in elements
{
	...
	if(im == 1 || im ==10){//BB
        ...
        if(im == 100)//north outlet
        {
           	f0 = gA[buff_memLR(0 ,x,y-1,pitch)];
        	f1 = gA[buff_memLR(1 ,x,y-1,pitch)];
        	f3 = gA[buff_memLR(3 ,x,y-1,pitch)];
        	f2 = gA[buff_memLR(2 ,x,y-1,pitch)];
        	f5 = gA[buff_memLR(5 ,x,y-1,pitch)];
        	f6 = gA[buff_memLR(6 ,x,y-1,pitch)];
        	f4 = gA[buff_memLR(4 ,x,y-1,pitch)];
        	f7 = gA[buff_memLR(7 ,x,y-1,pitch)];
        	f8 = gA[buff_memLR(8 ,x,y-1,pitch)];
        	f9 = gA[buff_memLR(9 ,x,y-1,pitch)];
        	f10= gA[buff_memLR(10,x,y-1,pitch)];
        	f11= gA[buff_memLR(11,x,y-1,pitch)];
        	f12= gA[buff_memLR(12,x,y-1,pitch)];
        	f13= gA[buff_memLR(13,x,y-1,pitch)];
        	f14= gA[buff_memLR(14,x,y-1,pitch)];
        	f15= gA[buff_memLR(15,x,y-1,pitch)];
        	f16= gA[buff_memLR(16,x,y-1,pitch)];
        	f17= gA[buff_memLR(17,x,y-1,pitch)];
        	f18= gA[buff_memLR(18,x,y-1,pitch)];
							...
							float omega, size_t pitch, int GPU, int zInner)//pitch in elements
{
	...
	if(im == 1 || im ==10){//BB
        ...
        if(im == 100)//north outlet
        {
           	f0 = hA[buff_memLR(0 ,x,y-1,pitch)];
        	f1 = hA[buff_memLR(1 ,x,y-1,pitch)];
        	f3 = hA[buff_memLR(3 ,x,y-1,pitch)];
        	f2 = hA[buff_memLR(2 ,x,y-1,pitch)];
        	f5 = hA[buff_memLR(5 ,x,y-1,pitch)];
        	f6 = hA[buff_memLR(6 ,x,y-1,pitch)];
        	f4 = hA[buff_memLR(4 ,x,y-1,pitch)];
        	f7 = hA[buff_memLR(7 ,x,y-1,pitch)];
        	f8 = hA[buff_memLR(8 ,x,y-1,pitch)];
        	f9 = hA[buff_memLR(9 ,x,y-1,pitch)];
        	f10= hA[buff_memLR(10,x,y-1,pitch)];
        	f11= hA[buff_memLR(11,x,y-1,pitch)];
        	f12= hA[buff_memLR(12,x,y-1,pitch)];
        	f13= hA[buff_memLR(13,x,y-1,pitch)];
        	f14= hA[buff_memLR(14,x,y-1,pitch)];
        	f15= hA[buff_memLR(15,x,y-1,pitch)];
        	f16= hA[buff_memLR(16,x,y-1,pitch)];
        	f17= hA[buff_memLR(17,x,y-1,pitch)];
        	f18= hA[buff_memLR(18,x,y-1,pitch)];
...
__global__ void update_inner_LR_interp(float* fA, float* fB, float* g, float* h, float* f_c,
							float omega, size_t pitch, int zInner, size_t pitch_c, int zInner_c, int GPU)//pitch in elements
{
	int x = threadIdx.x+blockIdx.x*blockDim.x;//coord in linear mem
	int y = threadIdx.y+blockIdx.y*blockDim.y;
	int z = threadIdx.z+blockIdx.z*blockDim.z;
	...
	float xcoord = LRX0+x*LRFACTOR;
	float ycoord = LRY0+y*LRFACTOR;
	float zcoord = LRZ0+(GPU*(zInner+2)+1+z)*LRFACTOR;
	int im = ImageFcn(xcoord,ycoord,zcoord);
    ...
    float v000 = f_c[f_memLR(0 ,xm,ym,zm,pitch_c,zInner_c)];
    float v001 = f_c[f_memLR(0 ,xp,ym,zm,pitch_c,zInner_c)];
    float v010 = f_c[f_memLR(0 ,xm,yp,zm,pitch_c,zInner_c)];
    float v011 = f_c[f_memLR(0 ,xp,yp,zm,pitch_c,zInner_c)];
    float v100 = f_c[f_memLR(0 ,xm,ym,zp,pitch_c,zInner_c)];
    float v101 = f_c[f_memLR(0 ,xp,ym,zp,pitch_c,zInner_c)];
    float v110 = f_c[f_memLR(0 ,xm,yp,zp,pitch_c,zInner_c)];
    float v111 = f_c[f_memLR(0 ,xp,yp,zp,pitch_c,zInner_c)];
    f0 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(1 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(1 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(1 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(1 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(1 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(1 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(1 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(1 ,xp,yp,zp,pitch_c,zInner_c)];
    f1 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(2 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(2 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(2 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(2 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(2 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(2 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(2 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(2 ,xp,yp,zp,pitch_c,zInner_c)];
    f2 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(3 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(3 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(3 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(3 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(3 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(3 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(3 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(3 ,xp,yp,zp,pitch_c,zInner_c)];
    f3 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(4 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(4 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(4 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(4 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(4 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(4 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(4 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(4 ,xp,yp,zp,pitch_c,zInner_c)];
    f4 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(5 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(5 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(5 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(5 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(5 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(5 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(5 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(5 ,xp,yp,zp,pitch_c,zInner_c)];
    f5 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(6 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(6 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(6 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(6 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(6 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(6 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(6 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(6 ,xp,yp,zp,pitch_c,zInner_c)];
    f6 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(7 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(7 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(7 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(7 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(7 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(7 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(7 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(7 ,xp,yp,zp,pitch_c,zInner_c)];
    f7 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(8 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(8 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(8 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(8 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(8 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(8 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(8 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(8 ,xp,yp,zp,pitch_c,zInner_c)];
    f8 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(9 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(9 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(9 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(9 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(9 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(9 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(9 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(9 ,xp,yp,zp,pitch_c,zInner_c)];
    f9 = trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(10 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(10 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(10 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(10 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(10 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(10 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(10 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(10 ,xp,yp,zp,pitch_c,zInner_c)];
    f10= trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(11 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(11 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(11 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(11 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(11 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(11 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(11 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(11 ,xp,yp,zp,pitch_c,zInner_c)];
    f11= trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(12 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(12 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(12 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(12 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(12 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(12 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(12 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(12 ,xp,yp,zp,pitch_c,zInner_c)];
    f12= trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(13 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(13 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(13 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(13 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(13 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(13 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(13 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(13 ,xp,yp,zp,pitch_c,zInner_c)];
    f13= trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(14 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(14 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(14 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(14 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(14 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(14 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(14 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(14 ,xp,yp,zp,pitch_c,zInner_c)];
    f14= trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(15 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(15 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(15 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(15 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(15 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(15 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(15 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(15 ,xp,yp,zp,pitch_c,zInner_c)];
    f15= trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(16 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(16 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(16 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(16 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(16 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(16 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(16 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(16 ,xp,yp,zp,pitch_c,zInner_c)];
    f16= trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(17 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(17 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(17 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(17 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(17 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(17 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(17 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(17 ,xp,yp,zp,pitch_c,zInner_c)];
    f17= trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
    v000 = f_c[f_memLR(18 ,xm,ym,zm,pitch_c,zInner_c)];
    v001 = f_c[f_memLR(18 ,xp,ym,zm,pitch_c,zInner_c)];
    v010 = f_c[f_memLR(18 ,xm,yp,zm,pitch_c,zInner_c)];
    v011 = f_c[f_memLR(18 ,xp,yp,zm,pitch_c,zInner_c)];
    v100 = f_c[f_memLR(18 ,xm,ym,zp,pitch_c,zInner_c)];
    v101 = f_c[f_memLR(18 ,xp,ym,zp,pitch_c,zInner_c)];
    v110 = f_c[f_memLR(18 ,xm,yp,zp,pitch_c,zInner_c)];
    v111 = f_c[f_memLR(18 ,xp,yp,zp,pitch_c,zInner_c)];   
    f18= trilinear_interp(v000, v001, v010, v011, v100, v101, v110, v111, xf, yf, zf);
...
__global__ void update_bottom_LR_interp(float* gA, float* gB, float* f, float* temp,
							float omega, size_t pitch, int GPU, int zInner)//pitch in elements
{
	int x = threadIdx.x+blockIdx.x*blockDim.x;//coord in linear mem
	int y = threadIdx.y+blockIdx.y*blockDim.y;
...
__global__ void update_top_LR_interp(float* hA, float* hB, float* f, float* temp,
							float omega, size_t pitch, int GPU, int zInner)//pitch in elements
{
	int x = threadIdx.x+blockIdx.x*blockDim.x;//coord in linear mem
	int y = threadIdx.y+blockIdx.y*blockDim.y;
...
__global__ void initialize_single(float *f, size_t pitch, int yDim, int zDim, int GPU_N)//pitch in elements
{
	int x = threadIdx.x+blockIdx.x*blockDim.x;//coord in linear mem
	int y = threadIdx.y+blockIdx.y*blockDim.y;
	int z = threadIdx.z+blockIdx.z*blockDim.z;
...
int main(int argc, char *argv[])
{
	...
	omegaLR = 2.0f/(1.0f+2.0f*(2.0f/omega-1.0f));
	if(LRFACTOR == 0.25f){
	...
	initialize_single<<<grid  , threads>>>(f_inner_A_d[n],pitch_elements,YDIM,ZDIM,GPU_N);
	initialize_single<<<grid  , threads>>>(f_inner_B_d[n],pitch_elements,YDIM,ZDIM,GPU_N);
	...
	cudaMalloc((void **) &     g_LR_temp[n], pitch*YLRDIM*         19*sizeof(float));
	cudaMalloc((void **) &     h_LR_temp[n], pitch*YLRDIM*         19*sizeof(float));
	...
	initialize_single<<<LRgrid   , LRthreads>>>(f_inner_LR_A_d[n],LRpitch_elements,YLRDIM,ZLRDIM,GPU_N);
	initialize_single<<<LRgrid   , LRthreads>>>(f_inner_LR_B_d[n],LRpitch_elements,YLRDIM,ZLRDIM,GPU_N);
	initialize_buffer<<<g_LR_grid, LRthreads>>>(      g_LR_A_d[n],LRpitch_elements);
	initialize_buffer<<<g_LR_grid, LRthreads>>>(      g_LR_B_d[n],LRpitch_elements);
	initialize_buffer<<<g_LR_grid, LRthreads>>>(      h_LR_A_d[n],LRpitch_elements);
	initialize_buffer<<<g_LR_grid, LRthreads>>>(      h_LR_B_d[n],LRpitch_elements);
	...
	for(int t = 0; t<TMAX; t+=2){
		...
		update_inner_LR <<<  LRgrid,  LRthreads, 0, stream_inner[n]>>>(f_inner_LR_A_d[n],f_inner_LR_B_d[n],      g_LR_A_d[n], h_LR_A_d[n],omega,LRpitch_elements,n,zLRInner);
		update_top_LR   <<<g_LR_grid, LRthreads, 0, stream_halo [n]>>>(      h_LR_A_d[n],      h_LR_B_d[n],f_inner_LR_A_d[n],h_LR_temp[n],omega,LRpitch_elements,n,zLRInner);
		update_bottom_LR<<<g_LR_grid, LRthreads, 0, stream_halo [n]>>>(      g_LR_A_d[n],      g_LR_B_d[n],f_inner_LR_A_d[n],g_LR_temp[n],omega,LRpitch_elements,n,zLRInner);
        }
		cudaDeviceSynchronize();
        for(int n = 0; n<GPU_N; n++){
		cudaSetDevice(n);
		...
		update_inner_LR <<<  LRgrid,  LRthreads, 0, stream_inner[n]>>>(f_inner_LR_B_d[n],f_inner_LR_A_d[n],      g_LR_B_d[n], h_LR_B_d[n],omega,LRpitch_elements,n,zLRInner);
		update_top_LR   <<<g_LR_grid, LRthreads, 0, stream_halo [n]>>>(      h_LR_B_d[n],      h_LR_A_d[n],f_inner_LR_B_d[n],h_LR_temp[n],omega,LRpitch_elements,n,zLRInner);
		update_bottom_LR<<<g_LR_grid, LRthreads, 0, stream_halo [n]>>>(      g_LR_B_d[n],      g_LR_A_d[n],f_inner_LR_B_d[n],g_LR_temp[n],omega,LRpitch_elements,n,zLRInner);
        }
